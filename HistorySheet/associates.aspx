...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Insert associates</div>
        <div class="panel-body">
            <div class="form-row">
                <div class="col-sm-2">
                    <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Name"></asp:TextBox>
                    <asp:RequiredFieldValidator ControlToValidate="txtName" Display="Dynamic" ErrorMessage="*" ForeColor="Red" ID="rfv1" runat="server" ValidationGroup="insert"></asp:RequiredFieldValidator>
                </div>
                <div class="col-sm-2">
                    <asp:TextBox ID="txtAliases" runat="server" CssClass="form-control" placeholder="Aliases"></asp:TextBox>
                    <asp:RequiredFieldValidator ControlToValidate="txtAliases" Display="Dynamic" ErrorMessage="*" ForeColor="Red" ID="RequiredFieldValidator1" ValidationGroup="insert" runat="server"></asp:RequiredFieldValidator>

                </div>
                <div class="col-sm-2">
                    <asp:TextBox ID="txtFatherName" runat="server" CssClass="form-control" placeholder="Father's Name"></asp:TextBox>
                    <asp:RequiredFieldValidator ControlToValidate="txtFatherName" Display="Dynamic" ErrorMessage="*" ForeColor="Red" ID="RequiredFieldValidator2" ValidationGroup="insert" runat="server"></asp:RequiredFieldValidator>

                </div>
                <div class="col-sm-2">
                    <asp:TextBox ID="txtResidence" runat="server" CssClass="form-control" placeholder="Residence"></asp:TextBox>
                    <asp:RequiredFieldValidator ControlToValidate="txtResidence" Display="Dynamic" ErrorMessage="*" ForeColor="Red" ID="RequiredFieldValidator3" ValidationGroup="insert" runat="server"></asp:RequiredFieldValidator>

                </div>
                <div class="col-sm-2">
                    <asp:TextBox ID="txtOccupation" runat="server" CssClass="form-control" placeholder="Occupation"></asp:TextBox>
                    <asp:RequiredFieldValidator ControlToValidate="txtOccupation" Display="Dynamic" ErrorMessage="*" ForeColor="Red" ID="RequiredFieldValidator4" ValidationGroup="insert" runat="server"></asp:RequiredFieldValidator>

                </div>
                <div class="col-sm-2">
                    <asp:Button ID="btnInsert" runat="server" CssClass="btn btn-primary" Text="Insert" ValidationGroup="insert" OnClick="btnInsert_Click"></asp:Button>
                </div>
            </div>
        </div>
    </div>
